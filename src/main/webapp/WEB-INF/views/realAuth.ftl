...
<body>
			...
			<div class="col-sm-9">
				<div class="panel panel-default">
					...
					<form class="form-horizontal" id="realAuthForm" method="post"
						action="/realAuth_save.do" novalidate="novalidate">
						<fieldset>
								...
								<div class="col-sm-8">
									...
									<div class="idCardItem">
										<div>
											...
											<a href="javascript:;" onclick="getFile()" id="uploadBtn1" >上传正面</a>
										</div>
	...
	<script type="text/javascript">
		function getFile(){
		       return document.getElementById('uploadImage1').click();
		   }
	</script>
</body>
</html>